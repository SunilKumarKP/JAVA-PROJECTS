...
public class JwtGenerator {
    ...
    private String createJWT(String id, String issuer, String subject, long expirationTime) {
        ...
        JwtBuilder builder = Jwts.builder().setId(id).setIssuedAt(now).setSubject(subject).setIssuer(issuer).signWith(signingKey);
    ...
    public static void main(String[] args) {
        ...
        String s = jwtG.createJWT("JWTExample", "JWTAuthentication", "Sunil", 100000L);
        System.out.println("Signed JWT ==>" + s);
    }
}
